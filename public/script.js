...
async function renderMenu() {
    ...
    allMenuItems = [
        // Cafe Gram
        { id:1, name:"Gram Special Burger", category:"Fast Food", price:150, outlet: "Cafe Gram", is_best_seller:1, description:"A classic crispy aloo tikki burger with fresh veggies and our special house sauce.", image:"https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=900&q=80", is_available: true },
        { id:2, name:"Margherita Pizza", category:"Pizza", price:160, outlet: "Cafe Gram", is_best_seller:1, description:"Classic cheese and tomato pizza.", image:"https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&w=800&q=80", is_available: true },
        { id:3, name:"Paneer Makhani Pizza", category:"Pizza", price:240, outlet: "Cafe Gram", is_best_seller:0, description:"Rich paneer makhani topped on a fresh pizza crust.", image:"https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80", is_available: true },
        { id:4, name:"Cold Coffee", category:"Cold Beverage", price:40, outlet: "Cafe Gram", is_best_seller:1, description:"Thick, sweet, and creamy chilled coffee blended to perfection.", image:"https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&w=900&q=80", is_available: true },
        
        // PU Canteen
        { id:5, name:"Samosa", category:"Fast Food", price:15, outlet: "PU Canteen", is_best_seller:0, description:"Hot perfectly spiced potato and pea samosa.", image:"https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=900&q=80", is_available: true },
        { id:6, name:"Spring Roll", category:"Rolls", price:60, outlet: "PU Canteen", is_best_seller:1, description:"Crispy fried rolls filled with fresh julienned vegetables.", image:"https://images.unsplash.com/photo-1603360946369-dc9bb6258143?auto=format&fit=crop&w=900&q=80", is_available: true },
        { id:7, name:"Chocolate Cheese Sandwich", category:"Sandwich", price:50, outlet: "PU Canteen", is_best_seller:0, description:"Sweet and savory chocolate cheese sandwich.", image:"https://images.unsplash.com/photo-1528736235302-52922df5c122?auto=format&fit=crop&w=900&q=80", is_available: true },
        { id:8, name:"Aloo Bhujia Grilled Sandwich", category:"Sandwich", price:30, outlet: "PU Canteen", is_best_seller:0, description:"Spicy aloo bhujia mix grilled to perfection.", image:"https://images.unsplash.com/photo-1528735602780-2552fd46c7af?auto=format&fit=crop&w=900&q=80", is_available: true },

        // Cibus Cafe
        { id:9, name:"Veg. Momos", category:"Chinese Food", price:100, outlet: "Cibus Cafe", is_best_seller:1, description:"Soft steamed momos with spicy dip.", image:"https://images.unsplash.com/photo-1563245372-f21724e3856d?auto=format&fit=crop&w=900&q=80", is_available: true },
        { id:10, name:"Kulhad Chai", category:"Hot Warm Up", price:20, outlet: "Cibus Cafe", is_best_seller:1, description:"Traditional spiced tea served in an earthen cup.", image:"https://images.unsplash.com/photo-1594911772125-07fc7a2d8d9f?auto=format&fit=crop&w=800&q=80", is_available: true },
        { id:11, name:"Aloo Paratha", category:"Paratha Hut", price:80, outlet: "Cibus Cafe", is_best_seller:0, description:"Stuffed potato paratha, served hot.", image:"https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=800&q=80", is_available: true },
        { id:12, name:"Plain Dosa", category:"South Indian", price:60, outlet: "Cibus Cafe", is_best_seller:0, description:"Crispy South Indian dosa served with chutney.", image:"https://images.unsplash.com/photo-1589301760014-d929f3979dbc?auto=format&fit=crop&w=800&q=80", is_available: true }
    ];
    filterAndDisplay();
}
